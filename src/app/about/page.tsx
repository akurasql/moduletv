      ...
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="space-y-6 text-sm leading-relaxed text-apple-lightGray">
          <section className="space-y-3">
            ...
            <p>
              **Module TV** is a high-fidelity, Apple TV-inspired web interface designed to showcase premium streaming hub mechanics, state persistence across profiles, and content metadata synchronization.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Module TV does not store, self-host, distribute, or stream any of the video files, torrents, or files displayed on the site. All player capabilities are powered externally through third-party iframe embed integrations (such as the CinemaOS player embed service at `https://cinemaos.tech`).
            </p>
            <p>
